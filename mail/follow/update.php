 ...
 */
$this->title = "<?= $typeAdded ?> updated on biobankapps";
...
">
    <?= $typeAdded ?> updated for software <?= "$software->name"?> on <?= Html::a("BiobankApps.com", Url::to(['site/index'])) ?></div>
<div style="font-size: 24px;">Dear <?= $follower->username?>,</div><br>A <?= $typeAdded ?> was updated for the software you follow. You can see this <?= $typeAdded ?> at the detailled view of the software : 
